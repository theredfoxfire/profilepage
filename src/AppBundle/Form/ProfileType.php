...
class ProfileType extends AbstractType
{
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		$posisi = array(
			...
			"Ketua Prodi Teknik Informatika & Komputer" => "Ketua Prodi Teknik Informatika & Komputer",
			...
			"Kepala Staff Badan Perpustakaan" => "Kepala Staff Badan Perpustakaan",
			"Kepala Staff Badan Informatika dan Telekomunikasi" => "Kepala Staff Badan Informatika dan Telekomunikasi",
			...
			"Staff Badan Perpustakaan" => "Staff Badan Perpustakaan",
			"Staff Badan Kemahasiswaan" => "Staff Badan Kemahasiswaan",
			"Staff Badan Keamanan" => "Staff Badan Keamanan",
			"Staff Badan Informatika dan Telekomunikasi" => "Staff Badan Informatika dan Telekomunikasi",
